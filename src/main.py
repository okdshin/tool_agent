...
from tool_agent.mcp import McpManager, McpManagerConfig
...
class Agent:
    def __init__(self, mcp_manager: McpManager | None = None, verbose: bool = False):
...
async def async_main():
    ...
    agent = Agent(mcp_manager, args.verbose)
    messages = []
